      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-x-hidden">
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden md:flex items-center space-x-6 lg:space-x-8">
                ...
                <button 
                  ...
                  className="text-slate-300 hover:text-yellow-400 transition-colors text-sm font-medium"
                >
                  {currentLanguage === 'pt' ? 'Privacidade' : 'Privacy'}
                </button>
                <button 
                ...
                <motion.button
                  ...
                  className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-4 py-2 rounded-lg font-semibold text-sm hover:from-yellow-400 hover:to-orange-400 transition-all shadow-lg"
                >
                  {t.freeTrialBtn}
                </motion.button>
              </nav>
            ...
            {showMobileMenu && (
              ...
              >
                <div className="px-4 py-4 space-y-3">
                  <button 
                    onClick={() => { router.push('/terms'); setShowMobileMenu(false); }}
                    className="block w-full text-left text-slate-300 hover:text-yellow-400 transition-colors py-2"
                  >
                    {currentLanguage === 'pt' ? 'Termos' : 'Terms'}
                  </button>
                  <button 
                    onClick={() => { router.push('/privacy'); setShowMobileMenu(false); }}
                    className="block w-full text-left text-slate-300 hover:text-yellow-400 transition-colors py-2"
                  >
                    {currentLanguage === 'pt' ? 'Privacidade' : 'Privacy'}
                  </button>
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <button
                      onClick={() => { router.push('/register'); setShowMobileMenu(false); }}
                      className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-4 py-2 rounded-lg font-semibold text-sm"
                    >
                      {t.freeTrialBtn}
                    </button>
                  </div>
        ...
        <section className="pt-20 pb-12 md:pt-24 md:pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          <div className="container mx-auto text-center relative z-10">
            ...
            >
              <div className="text-center bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-slate-700/30">
                <div className="text-2xl md:text-3xl font-bold text-yellow-400 mb-2">
                  {operationStats.totalTrades.toLocaleString()}
                </div>
                <div className="text-sm md:text-base text-slate-400">{t.stats.trades}</div>
              </div>
              <div className="text-center bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-slate-700/30">
                <div className="text-2xl md:text-3xl font-bold text-green-400 mb-2">
                  {operationStats.successRate}%
                </div>
                <div className="text-sm md:text-base text-slate-400">{t.stats.successRate}</div>
              </div>
              <div className="text-center bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-slate-700/30">
                <div className="text-2xl md:text-3xl font-bold text-blue-400 mb-2">
                  ${(operationStats.totalProfit / 1000000).toFixed(1)}M
                </div>
                <div className="text-sm md:text-base text-slate-400">{t.stats.totalProfit}</div>
              </div>
              <div className="text-center bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-slate-700/30">
                <div className="text-2xl md:text-3xl font-bold text-purple-400 mb-2">
                  {operationStats.activeUsers.toLocaleString()}
                </div>
                <div className="text-sm md:text-base text-slate-400">{t.stats.activeUsers}</div>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        {/* Demo Section */}
        <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-800/30 to-slate-900/30">
